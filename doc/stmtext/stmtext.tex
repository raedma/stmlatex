...
%
% Usage
%  - Compile using 'arara -w stmtext.tex'
% 
...
bibliography   \stmindex{Options!bibliography}   & false & Load the \stmlatexpackagelink{bibliography} package\\
calc           \stmindex{Options!calc}           & false & Load the \texttt{calc} package at the correct position relative to \texttt{stmtikz}\\
cleverref      \stmindex{Options!cleverref}      & false & Load the \texttt{cleveref} package at the correct position relative to \texttt{stmhyperref}\\
...
hyperref       \stmindex{Options!hyperref}       & true  & Load the \stmlatexpackagelink{stmhyperref} package\\
...
tabular        \stmindex{Options!tabular}        & false & Load the \stmlatexpackagelink{stmtabular} package\\
tikz           \stmindex{Options!tikz}           & false & Load the \stmlatexpackagelink{stmtikz} package\\
units          \stmindex{Options!units}          & false & Load the \stmlatexpackagelink{stmunits} package\\
\end{xltabular}
%\end{longtable}
%\end{filecontents}
%
...
% \label{sec:options:conditionalloxnewpage}
...
% \label{sec:options:institute}
% \stmindex{Options!institute}

\levelup{Option \protect\texttt{hyperref}}
...
All other options not explicitly list in \cref{sec:options:overview} are passed to the underlying document class. Thus, it has to be made sure that the underlying document class understands these options. At this point, switching the argument in the \nameref{sec:options:layout} may lead to problems in case the options is specific to a document class.
