...
This is a style for the glossary. It has one item column which is left aligned. The columns are \textit{Abbreviation} and \textit{Description}. Column headings are not printed.
...
\printglossary[type=main,style=stmacronymlabelstyle,nonumberlist]
%\printacronyms[style=stmacronymlabelstyle,nonumberlist]
\glstoctrue
