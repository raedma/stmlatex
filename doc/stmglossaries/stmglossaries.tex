...
\subsubsection{\protect\texttt{stmglossarylabelsourcestyle}}
\label{sec:usage:styles:glossary:stmglossarylabelsourcestyle}

\paragraph{Description}

This glossary style has four columns. The columns are \textit{Label}, \textit{Entry}, \textit{Description} and \textit{Sources}. The first and third column are left aligned, the second and last column are centered.
...
\subsubsection{\protect\texttt{stmglossarylabelsourcestyle2}}
\label{sec:usage:styles:glossary:stmglossarylabelsourcestyle2}

\paragraph{Description}

This glossary style has three columns. The columns are \textit{Label}, \textit{Entry} and \textit{Sources}. The first column is left aligned, the last two column is centered. The description is printed on a separate line over all columns.
...
\printglossary[type=main,style=stmglossarylabelsourcestyle2,nonumberlist]
\glstoctrue
