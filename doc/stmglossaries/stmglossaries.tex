...
% arara: pdflatex: {shell: yes, synctex: yes, interaction: nonstopmode}
% arara: pdflatex: {shell: yes, synctex: yes, interaction: nonstopmode}
% arara: remove: { patterns: [ '*.acn', '*.acr', '*.alg', '*.aux', '*.bbl', '*.bcf', '*.blg', '*.dvi', '*.glg', '*.glo', '*.gls', '*.idx', '*.ilg', '*.ind', '*.ist', '*kate-swp', '*.lock', '*.lof', '*.log', '*.lol', '*.lot', '*.mw', '*.nlo', '*.out', '*.ps', '*.run.xml', '*.slg*', '*.syg*', '*.syi*', '*.synctex', '*.synctex.gz', '*.tex.backup', '*tex.kate-swp', '*.toc*', '*.user.adi*', 'stmglossaries-*.tex' ], recursive: yes }
...
% \begin{equation}  
% \glssymbol{sym:scalar:load:force} = \glssymbol{sym:scalar:mass}\glssymbol{sym:scalar:acceleration}
% \end{equation}
...
% \begin{equation}  
% \divergenceoperator(\glssymbol{sym:vector:mech:stress:cauchy})+\glssymbol{sym:vector:load:bodyforce}=\glssymbol{sym:scalar:mat:density}\glssymbol{sym:vector:mech:acceleration}
% \end{equation}
% 
% \begin{equation}  
% \glssymbol{sym:vector:mech:stress:cauchy} = \glssymbol{sym:matrix:mat:stiffness}\glssymbol{sym:vector:mech:strain}
% \end{equation}
% 
% \begin{equation}  
% \glssymbol{sym:state:scalar:position:deformed},\glssymbol{sym:state:vector:direction:deformed},\glssymbol{sym:state:double:modulus}
% \end{equation}
